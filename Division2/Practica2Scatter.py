...
if rank==0:
    ...
    array_to_share=[(x[0],y[0]),(x[0],y[0]),(x[1],y[1]),(matriz1,matriz2)]
...
if rank==3:
    ...
    sumaTotal=np.concatenate((A,B),axis=1,out=None)
    restaTotal=np.concatenate((A1,B1),axis=1,out=None)
